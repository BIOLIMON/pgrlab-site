...
export const contentData: Content = {
  ...
  "heroSubtext": "From single-cell resolution to field-scale phenotyping, we integrate systems biology and multi-omics to understand how crops perceive and adapt to environmental stress.",
  "metrics": [
  ...
  "researchThemes": [
    {
      ...
      "description": "We investigate how plants integrate environmental and nutritional signals through dynamic gene regulatory networks. Our focus is on the architecture, hierarchy, and decision-making properties of transcriptional circuits that balance growth, resource allocation, and stress responses.",
      "icon": "Activity"
    },
    {
      "id": "theme-2",
      "title": "Drought Adaptation Strategies",
      "description": "We study the molecular strategies that enable plants to anticipate, perceive, and respond to water limitation. Our research combines comparative genomics, transcriptomics, and regulatory analysis to uncover adaptive programs in stress-resilient species.",
      "icon": "Droplets"
    },
    {
      "id": "theme-3",
      "title": "Nitrogen Signaling and Use Efficiency",
      "description": "We explore how plants sense, interpret, and optimize nitrogen availability through multilayered regulatory networks. Our work integrates chromatin dynamics, transcriptional regulation, and computational modeling to improve nitrogen use efficiency.",
      "icon": "Zap"
    },
    {
      "id": "theme-4",
      "title": "Multi‑Omics Integration and Predictive Plant Systems",
      "description": "We integrate genotypic, transcriptomic, epigenomic, phenotypic, and environmental data to build predictive models of plant performance under variable field conditions. This line connects molecular regulation with whole‑plant physiology through data-driven and sensor-informed approaches.",
      "icon": "Layers"
    }
  ],
  "publications": [
    {
      "id": "pub-1",
      "title": "Antagonistic regulation of nitrogen and drought signaling mediated by NIN-like protein 7 transcription factor in Arabidopsis thaliana",
      "authors": "Johnson, N. R., Moyano, T. C., Araus, V., Osorio, C., Huang, J., Frangos, S., … & Álvarez, J. M.",
      "journal": "PNAS",
      "year": 2026,
    ...
    {
      "id": "pub-2",
      "title": "Desert-adapted tomato Solanum pennellii exhibit unique regulatory elements and stress-ready transcriptome patterns to drought",
      "authors": "Contreras-Riquelme, J. S., Contreras, M., Moyano, T. C., Sjoberg, R., Jimenez-Gomez, J., & Alvarez, J. M.",
      "journal": "PLoS ONE",
      "year": 2025,
    ...
    {
      "id": "pub-3",
      "title": "Organ-level gene-regulatory networks inferred from transcriptomic data reveal context-specific regulation and highlight novel regulators of ripening and ABA-mediated responses in tomato",
      "authors": "Fernández, J. D., Navarro-Payá, D., Santiago, A., … Álvarez, J. M., … & Vidal, E. A.",
    ...
    {
      "id": "pub-4",
      "title": "Two antagonistic gene regulatory networks drive Arabidopsis root hair growth at low temperature",
    ...
    {
      "id": "pub-6",
      "title": "Insights into molecular links and transcription networks integrating drought stress and nitrogen signaling",
    ...
    {
      "id": "pub-7",
      "title": "Dynamic changes in mRNA nucleocytoplasmic localization reveal nutrient-responsive gene regulatory mechanisms",
      "authors": "Fonseca, A., Riveras, E., Moyano, T. C., Alvarez, J. M., Rosa, S., & Gutiérrez, R. A.",
    ...
    {
      "id": "pub-8",
      "title": "Spatiotemporal analysis identifies ABF2 and ABF3 as key regulators of drought-responsive gene expression",
      "authors": "Contreras-López, O., Vidal, E. A., Riveras, E., Alvarez, J. M., … & Gutiérrez, R. A.",
      "journal": "PNAS",
      "year": 2022,
    ...
    {
      "id": "pub-11",
      "title": "Local Changes in Chromatin Accessibility and Transcriptional Networks Underlying the Nitrate Response in Arabidopsis Roots",
  ...
  "resources": [
    {
      "name": "PRINT",
      "description": "Computational tool to explore plant gene regulatory networks through integration of curated databases, inferred GRNs, and Gene Ontology annotations — with focus on stress- and hormone-related subnetworks.",
      "link": "https://github.com/gabsga/PlantRegulatoryNetworkTool",
      "type": "Software"
    },
    {
      "name": "PYNER",
      "description": "Integrated scientific search system to query and link genomic projects (BioProject), experimental data (SRA), and scientific publications (PubMed) using natural language.",
