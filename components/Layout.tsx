          ...
          {navItems.map((item) => (
            <Link
              ...
              className={`text-sm font-medium transition-colors ${
                pathname === item.path ? 'text-cyan-600' : 'text-slate-600 hover:text-slate-900'
              }`}
            >
              {item.label}
            </Link>
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-12 mb-16'>
          <div className='col-span-1 md:col-span-2'>
            ...
            <p className='text-slate-500 max-w-sm'>
              Plant Genome Regulation Lab at CBV-UNAB Santiago. Pushing the boundaries of plant
          ...
          <div>
            ...
            <ul className='space-y-4 text-sm font-medium text-slate-600'>
              ...
              <li>
                <Link to='/research' className='hover:text-cyan-600'>
                  Our Science
                </Link>
              </li>
              <li>
                <Link to='/publications' className='hover:text-cyan-600'>
                  Recent Papers
                </Link>
              </li>
              <li>
                <Link to='/team' className='hover:text-cyan-600'>
                  Team
                </Link>
              </li>
              <li>
          ...
          <div>
            <h3 className='font-semibold text-sm uppercase tracking-wider text-slate-400 mb-2'>
              Affiliations
            </h3>
            <AffiliationsGraph />
          </div>
