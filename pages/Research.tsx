...
const fundingData = [
  {
    ...
    description:
      'Identifying key transcription factors and dynamic transcriptional logic to improve drought tolerance and growth in tomatoes.',
    period: 'Active 2025',
  },
  {
    name: 'Núcleo Milenio PhytoLearning',
    description:
      'Interinstitutional project integrating data science and AI with plant biology to enhance crop resilience under climate change.',
    period: 'Active 2024–2027',
  },
  {
    name: 'EMBO Global Investigator',
    description:
      'International distinction granting access to European collaboration networks, leadership training, and funding for frontier research.',
...
export const Research: React.FC = () => {
  useSeo({
    ...
    description:
      'Our research themes: genome-scale regulatory networks, stress preparedness, transcriptional reprogramming, and systems-level modeling for crop resilience.',
    path: '/research',
  });
  return (
    <div className='pt-20'>
      <Section>
        ...
        <div className='grid grid-cols-1 gap-16'>
          {contentData.researchThemes.map((theme, i) => {
            ...
            const imgSrc =
              themeImages[theme.id] || `https://picsum.photos/seed/${theme.id}/800/600`;
            return (
              <div
                key={theme.id}
      ...
      <Section className='bg-slate-900 text-white rounded-t-[60px]'>
        <SectionHeader
          ...
          subtitle='Our work is supported by top national and international funding agencies.'
        />
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          {fundingData.map((fund, i) => (
            <div key={i} className='bg-white/5 border border-white/10 p-10 rounded-[40px]'>
              ...
              <p className='text-slate-400 text-sm leading-relaxed mb-6'>{fund.description}</p>
