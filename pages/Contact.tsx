          ...
          <div>
            ...
            <div className='space-y-12'>
              ...
              <div>
                ...
                <a
                  href='mailto:r.genomavegetal@gmail.com'
                  className='text-xl font-bold hover:text-cyan-600 transition-colors cursor-pointer'
                >
                  r.genomavegetal@gmail.com
                </a>
              </div>
              <div>
                <h3 className='text-xs font-bold text-slate-400 uppercase tracking-widest mb-4'>
                ...
                <div className='flex space-x-6'>
                  <a
                    href='https://www.instagram.com/jma.lab/'
                    target='_blank'
                    rel='noreferrer'
                  ...
                  <a
                    href='https://investigadores.anid.cl/es/public_search/researcher?id=21685'
                    target='_blank'
                    rel='noreferrer'
                    className='font-bold text-slate-900 hover:text-cyan-600'
                  >
            ...
            <Card className='!p-12'>
              ...
              <form className='space-y-6' onSubmit={(e) => e.preventDefault()}>
                <div>
                  ...
                  <input
                    type='text'
                    className='w-full p-4 bg-slate-50 border border-slate-100 rounded-2xl focus:outline-none focus:ring-2 focus:ring-cyan-500/20'
                ...
                <div>
                  ...
                  <textarea
                    className='w-full p-4 bg-slate-50 border border-slate-100 rounded-2xl focus:outline-none focus:ring-2 focus:ring-cyan-500/20 h-32'
